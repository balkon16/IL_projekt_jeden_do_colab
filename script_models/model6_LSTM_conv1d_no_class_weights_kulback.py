...
# define tensorboard log collection
# tb = TensorBoard('./tensorboards/'+file_name
#           , histogram_freq=0
...
# change the dependent variable to one-hot version
y_tr_categorical = to_categorical(dict_to_export['y_tr'], num_classes=5)
